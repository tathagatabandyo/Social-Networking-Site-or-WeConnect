...
<div id="navbar" class="d-flex justify-content-between align-items-center bg-white position-sticky top-0 start-0">
    <div id="left_div" class="d-flex align-items-center position-relative">
        ...
        <div id="left_slide_l_bar">
            <div class="container m-0 p-0">
                <a href="profile?uid=<?php echo $login_user_id;?>" class="row justify-content-start p-3 row_ele_style">
        ...
        <div id="search_friend_modal" class="position-absolute">
            ...
            <div class="search_result mt-3" id="search_result_ele">
    ...
    <div id="middle_div" class="d-flex align-items-center position-relative">
        ...
        <a href="user" id="home_icon_ele" class="middle_icon_ele active_middle_icon" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Home">
            <span id="home_icon">
        ...
        <!-- <div id="friend_icon_ele" class="middle_icon_ele">
            <span id="friend_icon">
        ...
        <div id="watch_icon_ele" class="middle_icon_ele">
            <span id="watch_icon">
                <svg viewBox="0 0 28 28" class="a8c37x1j ms05siws l3qrxjdp b7h9ocf4 py1f6qlh" fill="currentColor" height="28" width="28">
    ...
    <div id="right_div" class="d-flex align-items-center position-relative">
        <a href="profile?uid=<?php echo $login_user_id;?>" id="profile_ele" class="d-flex align-items-center">
            <div id="profile_img">
                <?php
                    if(!isset($_SESSION)) {
                        session_start();
                    ...
                    if($image_type == "text") {
                        ...
                        echo "<img id='profile__img_r' src='img/profile_img/$image_name'>";
                    }
                    mysqli_close($conn);
                ?>
            </div>
        ...
        <div id="popup_ele_modal" class="position-absolute">
            ...
            <div id="account_settings" class="popup_ele">
                <a href="profile?uid=<?php echo $login_user_id;?>" id="profile_user_" class="account_settings_child d-flex mb-3">
