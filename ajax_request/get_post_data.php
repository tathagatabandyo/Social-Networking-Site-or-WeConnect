<?php
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        // $q = "SELECT post_message,post_privacy,post_timestamp FROM post WHERE user_id=$user_id ORDER BY post_id DESC";
        ...
        if(mysqli_num_rows($result)>0) {
            ...
            while($arr = mysqli_fetch_assoc($result)) {
                ...
                if($arr['user_id'] == $user_id) {
                    $post_get_in_c_t .= sha1($arr['post_id'])."/"; 
                    $icon_class_name = "";
                                    ...
                                    <div class='row justify-content-start align-items-center'>
                                        <div class='col-12 d-flex align-items-center'>
                                            ...
                                            <div class='d-flex flex-column ms-2'>
                                                ...
                                                <span class='user_time_icon'><a href='#' data-bs-toggle='tooltip' data-bs-placement='bottom' title='$date_title' class='me-1'>$date</a> <i class='$icon_class_name' data-bs-toggle='tooltip' data-bs-placement='bottom' title='{$arr['post_privacy']}'></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class='row'>
                    ...
                    // }
                    // $date = date("d/m/Y",$arr['post_timestamp']);
                    // $date = date("d/m/Y h:i:s A",$arr['post_timestamp']);
        ...
        $info['mdata'] = "<div class='col-xl-5 col-lg-7 col-md-9 res_ele'>
        ...
        // echo $data;
        if($post_get_in_c_t != "") {
            $post_get_in_c_t = substr($post_get_in_c_t, 0, (strlen($post_get_in_c_t) - 1));
        }
