    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if (isset($_POST["search_value"])) {
            ...
            if($search_value != "") {
                ...
                $q = "SELECT user_id,user_name,image_type,profile_image FROM user WHERE (user_id!=$login_user_id AND user_name LIKE '%$search_value%');";
